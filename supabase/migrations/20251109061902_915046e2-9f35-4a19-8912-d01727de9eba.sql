...
INSERT INTO public.thrift_items (name, description, tags, price, image_url, store_name, style_category) VALUES
  ...
  ('Silk Tie', 'Luxurious silk tie in navy with subtle pattern. Professional accessory.', ARRAY['tie', 'silk', 'formal', 'navy'], 18.00, 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400', 'Classic Closet', 'Formal'),
  ...
  ('Leather Belt', 'Vintage brown leather belt with brass buckle. Timeless accessory.', ARRAY['belt', 'leather', 'vintage', 'brown'], 22.00, 'https://images.unsplash.com/photo-1624222247344-550fb60583bb?w=400', 'Retro Finds', 'Vintage');